...
import saturndevelopment.saturnclient.commands.arguments.MacroArgumentType;
import saturndevelopment.saturnclient.events.world.TickEvent;
import saturndevelopment.saturnclient.systems.macros.Macro;
...
class ScheduledMacro {
    ...
    private void runMacro() {
        if (SaturnClient.mc.player == null) return;
