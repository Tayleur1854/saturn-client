...
import saturndevelopment.saturnclient.systems.hud.HudRenderer;
...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = SaturnClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = SaturnClient.identifier("textures/container-transparent.png");
