...
package saturndevelopment.saturnclient.systems.accounts.types;
...
public class TheAlteningAccount extends Account<TheAlteningAccount> implements TokenAccount {
    ...
    public boolean fetchInfo() {
        ...
        try {
            ...
            SaturnClient.LOG.error("Invalid TheAltening credentials.");
            return false;
        } catch (Exception e) {
            SaturnClient.LOG.error("Failed to fetch info for TheAltening account!");
            return false;
        }
    }
    ...
    public boolean login() {
        ...
        try {
            ...
            SaturnClient.LOG.error("Failed to login with TheAltening.");
            return false;
        }
    }
