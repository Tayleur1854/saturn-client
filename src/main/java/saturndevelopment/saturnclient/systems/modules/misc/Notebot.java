...
import saturndevelopment.saturnclient.gui.widgets.WLabel;
...
import saturndevelopment.saturnclient.utils.notebot.NotebotUtils;
import saturndevelopment.saturnclient.utils.notebot.decoder.SongDecoder;
import saturndevelopment.saturnclient.utils.notebot.decoder.SongDecoders;
import saturndevelopment.saturnclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import saturndevelopment.saturnclient.utils.notebot.song.Note;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = SaturnClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    SaturnClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
