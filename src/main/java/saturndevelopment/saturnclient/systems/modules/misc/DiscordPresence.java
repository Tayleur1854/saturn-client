...
public class DiscordPresence extends Module {
    ...
    public void onActivate() {
        ...
        String largeText = "%s %s".formatted(SaturnClient.NAME, SaturnClient.VERSION);
        if (!SaturnClient.BUILD_NUMBER.isEmpty()) largeText += " Build: " + SaturnClient.BUILD_NUMBER;
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.setDetails(SaturnClient.NAME + " " + (SaturnClient.BUILD_NUMBER.isEmpty() ? SaturnClient.VERSION : SaturnClient.VERSION + " " + SaturnClient.BUILD_NUMBER));
