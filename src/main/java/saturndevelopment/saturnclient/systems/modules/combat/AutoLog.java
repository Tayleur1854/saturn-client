...
import saturndevelopment.saturnclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        SaturnClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        SaturnClient.EVENT_BUS.unsubscribe(staticListener);
    }
}
