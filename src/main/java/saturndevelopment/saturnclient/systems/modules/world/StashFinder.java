...
import saturndevelopment.saturnclient.gui.widgets.containers.WVerticalList;
...
import saturndevelopment.saturnclient.utils.misc.text.RunnableClickEvent;
...
public class StashFinder extends Module {
    ...
    private void saveCsv() {
        try {
            ...
            SaturnClient.LOG.error("Error while writing the stash list to csv", e);
        }
    }
    ...
    private void saveJson() {
        try {
            ...
            SaturnClient.LOG.error("Error while writing the stash list to json", e);
        }
    }

    private File getJsonFile() {
        return new File(new File(new File(SaturnClient.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(SaturnClient.FOLDER, "stashes"), Utils.getFileWorldName()), "stashes.csv");
    }
