...
import saturndevelopment.saturnclient.mixin.MinecraftClientMixin;
import saturndevelopment.saturnclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
import saturndevelopment.saturnclient.systems.modules.combat.KillAura;
...
import saturndevelopment.saturnclient.utils.misc.HorizontalDirection;
import saturndevelopment.saturnclient.utils.misc.MBlockPos;
import saturndevelopment.saturnclient.utils.player.*;
import saturndevelopment.saturnclient.utils.player.*;
import saturndevelopment.saturnclient.utils.render.NametagUtils;
...
import saturndevelopment.saturnclient.utils.world.Dir;
import saturndevelopment.saturnclient.utils.world.TickRate;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
