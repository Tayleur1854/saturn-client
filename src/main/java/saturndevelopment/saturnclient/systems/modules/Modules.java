...
package saturndevelopment.saturnclient.systems.modules;
...
import saturndevelopment.saturnclient.events.meteor.ActiveModulesChangedEvent;
import saturndevelopment.saturnclient.events.meteor.KeyEvent;
import saturndevelopment.saturnclient.events.meteor.ModuleBindChangedEvent;
...
import saturndevelopment.saturnclient.commands.commands.BindCommand;
import saturndevelopment.saturnclient.systems.modules.combat.*;
import saturndevelopment.saturnclient.systems.modules.misc.*;
import saturndevelopment.saturnclient.systems.modules.misc.swarm.Swarm;
...
import saturndevelopment.saturnclient.systems.modules.movement.speed.Speed;
import meteordevelopment.meteorclient.systems.modules.player.*;
import meteordevelopment.meteorclient.systems.modules.render.*;
import saturndevelopment.saturnclient.systems.modules.player.*;
import saturndevelopment.saturnclient.systems.modules.render.*;
import saturndevelopment.saturnclient.systems.modules.render.blockesp.BlockESP;
...
import saturndevelopment.saturnclient.systems.modules.world.*;
import saturndevelopment.saturnclient.systems.modules.world.Timer;
import saturndevelopment.saturnclient.utils.Utils;
import saturndevelopment.saturnclient.utils.misc.Keybind;
import saturndevelopment.saturnclient.utils.misc.ValueComparableMap;
...
public class Modules extends System<Modules> {
    ...
    void addActive(Module module) {
        synchronized (active) {
            if (!active.contains(module)) {
                active.add(module);
                SaturnClient.EVENT_BUS.post(ActiveModulesChangedEvent.get());
            }
        }
    }
    ...
    private boolean onBinding(boolean isKey, int value, int modifiers) {
        ...
        SaturnClient.EVENT_BUS.post(ModuleBindChangedEvent.get(moduleToBind));
        moduleToBind = null;
        ...
        synchronized (active) {
            for (Module module : getAll()) {
                if (module.isActive() && !module.runInMainMenu) {
                    SaturnClient.EVENT_BUS.subscribe(module);
                    module.onActivate();
                }
            }
        }
    ...
    private void onGameLeft(GameLeftEvent event) {
        synchronized (active) {
            for (Module module : getAll()) {
                if (module.isActive() && !module.runInMainMenu) {
                    SaturnClient.EVENT_BUS.unsubscribe(module);
                    module.onDeactivate();
                }
            }
        }
