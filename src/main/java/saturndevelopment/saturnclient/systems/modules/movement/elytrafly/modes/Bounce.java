...
package saturndevelopment.saturnclient.systems.modules.movement.elytrafly.modes;

import saturndevelopment.saturnclient.SaturnClient;
import saturndevelopment.saturnclient.events.packets.PacketEvent;
import saturndevelopment.saturnclient.systems.modules.movement.elytrafly.ElytraFlightMode;
    ...
    private static boolean startGliding(ClientPlayerEntity player) {
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            if (LivingEntity.canGlideWith(player.getEquippedStack(equipmentSlot), equipmentSlot)) {
                SaturnClient.mc.executeSync(player::startGliding);
                return true;
            }
        }
