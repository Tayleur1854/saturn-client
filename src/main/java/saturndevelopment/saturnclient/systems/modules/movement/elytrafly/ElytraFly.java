...
package saturndevelopment.saturnclient.systems.modules.movement.elytrafly;
...
import saturndevelopment.saturnclient.mixin.AbstractBlockAccessor;
...
import saturndevelopment.saturnclient.systems.modules.movement.elytrafly.modes.Bounce;
import saturndevelopment.saturnclient.systems.modules.movement.elytrafly.modes.Packet;
import saturndevelopment.saturnclient.systems.modules.movement.elytrafly.modes.Pitch40;
import saturndevelopment.saturnclient.systems.modules.movement.elytrafly.modes.Vanilla;
import saturndevelopment.saturnclient.systems.modules.player.ChestSwap;
import saturndevelopment.saturnclient.systems.modules.player.Rotation;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        SaturnClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        SaturnClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        SaturnClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        SaturnClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
