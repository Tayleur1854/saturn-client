...
import static saturndevelopment.saturnclient.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(SaturnClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(SaturnClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(SaturnClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(SaturnClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(SaturnClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(SaturnClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(SaturnClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(SaturnClient.identifier("textures/icons/gui/paste.png"));
