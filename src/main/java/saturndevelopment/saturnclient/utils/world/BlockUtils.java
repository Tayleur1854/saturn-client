...
package saturndevelopment.saturnclient.utils.world;
...
import saturndevelopment.saturnclient.systems.modules.player.InstantRebreak;
...
public class BlockUtils {
    ...
    public static void init() {
        SaturnClient.EVENT_BUS.subscribe(BlockUtils.class);
    }
