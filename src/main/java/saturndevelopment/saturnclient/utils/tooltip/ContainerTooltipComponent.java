...
package saturndevelopment.saturnclient.utils.tooltip;
...
public class ContainerTooltipComponent implements TooltipComponent, MeteorTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = SaturnClient.identifier("textures/container.png");
