...
import saturndevelopment.saturnclient.systems.modules.render.Chams;
...
public class ChamsShader extends EntityShader {
    ...
    public ChamsShader() {
        ...
        SaturnClient.EVENT_BUS.subscribe(ChamsShader.class);
    }
    ...
    public static void load() {
        try {
            ...
            for (String fileFormat : FILE_FORMATS) {
                Optional<Resource> optional = mc.getResourceManager().getResource(SaturnClient.identifier("textures/chams." + fileFormat));
            ...
            SaturnClient.LOG.error("Error loading the chams shader", e);
        }
    }
