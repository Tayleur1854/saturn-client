...
package saturndevelopment.saturnclient.utils;
...
import saturndevelopment.saturnclient.systems.modules.render.BetterTooltips;
import saturndevelopment.saturnclient.systems.modules.world.Timer;
import saturndevelopment.saturnclient.utils.misc.Names;
import saturndevelopment.saturnclient.utils.player.EChestMemory;
import saturndevelopment.saturnclient.utils.render.PeekScreen;
...
import saturndevelopment.saturnclient.utils.world.BlockEntityIterator;
import saturndevelopment.saturnclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        SaturnClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            SaturnClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
