...
loom {
    accessWidenerPath = file("src/main/resources/saturn-client.accesswidener")
}
...
tasks {
    ...
    jar {
        ...
        manifest {
            attributes["Main-Class"] = "saturndevelopment.saturnclient.Main"
        }
    }
